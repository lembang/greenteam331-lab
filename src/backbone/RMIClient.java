...
public class RMIClient {
    ...
    public Vector getAllDataToClient(){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,"GetAllDataToClient Error :" + ex);
        }
       return AllData;
    }
    public void insertDataToServer(String strGUID, String strName, String strPassword){
        try{
            ...
            JOptionPane.showMessageDialog(null,"InsertDataToServer Error :" + ex);
        }
    }
    
    public void updateDataToServer(String strGUID, String strName, String strPassword){
        try{
            rIface.setStrGUID(strGUID);
            rIface.setStrName(strName);
            rIface.setStrPassword(strPassword);
            ...
            JOptionPane.showMessageDialog(null,"UpdateDataToServer Error :" + ex);
        }
    }
    ...
    public void DeleteDataOnServer(String strGUID){
        try{
            ...
            JOptionPane.showMessageDialog(null,"Delete data on the server failed :" + ex);
        }
    }
